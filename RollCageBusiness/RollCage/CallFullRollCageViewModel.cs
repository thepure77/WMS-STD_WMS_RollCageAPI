...
{
    public partial class CallFullRollCageViewModel : Result
    {
        ...
        List<CallFullRollCageViewModel> item { get; set; }
        ...
        public class ListScanOut : Result
        {

            public ListScanOut()
            {
                ListScanOutmodel = new List<ListScanOutmodel>();
            }
            public List<ListScanOutmodel> ListScanOutmodel { get; set; }
        }

        public class ListScanOutmodel
        {
            public string description { get; set; }
